(function(ionic) {
  ...
  var SwipeableCardView = ionic.views.View.inherit({
    ...
    setZIndex: function(index) {
      this.el.style.zIndex = index + 9999999999999999;
    },
    ...
    transitionOut: function() {
      ...
      // } else {
        // Fly left
        var rotateTo = (this.rotationAngle + ((this.rotationDirection * -1) * 0.2)) || (Math.random() * 0.3);
        var duration = 0.5;
        var deviceWidth = getDeviceWidth();
        var flyX = (this.rotationDirection === -1)? this.x + deviceWidth: this.x - deviceWidth;
        this.el.style[TRANSITION] = '-webkit-transform ' + duration + 's ease-in-out';
        this.el.style[ionic.CSS.TRANSFORM] = 'translate3d(' + flyX + 'px,' + this.y + 'px, 0) rotate(' + rotateTo + 'rad)';
    ...
    _doDrag: function(e) {
      ...
      // console.log("rotationAngle",this.rotationAngle, this.rotationDirection);
